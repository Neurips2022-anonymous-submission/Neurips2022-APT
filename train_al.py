...
from gcc.contrastive.criterions import NCESoftmaxLoss, NCESoftmaxLossNS, NCESoftmaxLoss_reduce, NCESoftmaxLoss_sam, \
    NCESoftmaxLoss_sam_threshold, NCESoftmaxLoss_sam_threshold_new
...
from gcc.datasets import (
    ...
    LoadBalanceGraphDataset_al_each_one,
...
def main(args):
    ...
    if args.finetune:
        ...
        criterion = NCESoftmaxLoss_sam_threshold_new() if args.moco else NCESoftmaxLossNS()
